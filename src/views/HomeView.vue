...
<div class="slide1">
    <div class="content">
        ...
        <p>With Algospace, you can find clear-cut solutions with detailed explanations, for problems spanning
           across the BIO and IOI syllabus. </p>
    </div>
...
export default {
    setup()
    {
        ...
        const typeValue = ref('')
        const displayTextArray = ["algospace","\"Algospace\"", "ALGOSPACE", "algo_space;"]
